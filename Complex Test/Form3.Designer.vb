...
Partial Class SAConnection
#Region "Upgrade Support "
	Private Shared m_vb6FormDefInstance As SAConnection
	Private Shared m_InitializingDefInstance As Boolean
	Public Shared Property DefInstance() As SAConnection
		Get
		...
		End Get
		Set(ByVal Value As SAConnection)
			m_vb6FormDefInstance = Value
		End Set
	End Property
#End Region
#Region "Windows Form Designer generated code "
	Public Shared Function CreateInstance() As SAConnection
		Dim theInstance As SAConnection = New SAConnection()
		Return theInstance
	End Function
	Private visualControls() As String = New String() {"components", "ToolTipMain", "CancelButton_Renamed", "OKButton", "AddressText", "Label4", "Frame2", "TCPIPCheck", "BoardTextGPIB", "PrimaryTextGPIB", "SecondaryTextGPIB", "Label1", "Label2", "Label3", "Frame1", "GPIBCheck"}
	...
	<System.Diagnostics.DebuggerStepThrough()> _
	 Private Sub InitializeComponent()
        ...
        Me.CancelButton_Renamed.Location = New System.Drawing.Point(188, 228)
        ...
        Me.SecondaryTextGPIB.TabIndex = 2
        ...
        Me.Name = "SAConnection"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.Text = "Spectrum Analyzer Connection"
	...
	Sub ReLoadForm(ByVal addEvents As Boolean)
		If addEvents Then
			AddHandler MyBase.Closed, AddressOf Me.SAConnection_Closed
		End If
	End Sub
#End Region
End Class